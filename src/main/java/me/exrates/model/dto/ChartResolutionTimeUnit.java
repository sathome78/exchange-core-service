...
public enum ChartResolutionTimeUnit {
   ...
   private Integer refreshDelaySeconds;
    ...
    public static me.exrates.model.enums.ChartResolutionTimeUnit fromShortName(String shortName) {
        return Arrays.stream(me.exrates.model.enums.ChartResolutionTimeUnit.values()).filter(item -> item.getShortName().equals(shortName)).findFirst()
